...
<Library LVVersion="17008000">
	...
	<Item Name="UI助手.lvlib" Type="Library" URL="../库-模板-UI/UI助手.lvlib"/>
	<Item Name="模板-功能全局变量.lvlib" Type="Library" URL="../库-模板-功能全局变量/模板-功能全局变量.lvlib"/>
	<Item Name="模板-配置文件相关.lvlib" Type="Library" URL="../库-模板-配置文件相关/模板-配置文件相关.lvlib"/>
</Library>
